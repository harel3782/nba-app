...
export function AdminResultsControl() {
	...
	return (
		<div className="bg-gray-900 p-6 rounded-xl border border-gray-700 max-w-4xl mx-auto my-8">
			<h2 className="text-2xl text-white font-bold mb-6 border-b border-gray-700 pb-2">👮 Admin: Set Real Results</h2>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
				{STAGES.map(stage => {
					...
					return (
						<div key={stage.id} className="bg-black/40 p-3 rounded border border-gray-700">
							<div className="text-xs text-gray-400 uppercase mb-2">{stage.label}</div>
