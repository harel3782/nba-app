...
export function ProfileModal({ isOpen, onClose, currentName, onUpdate }: Props) {
				...
				<div className="space-y-4 relative z-10">
					...
					<div className="flex gap-3 mt-6">
						...
						<button
							onClick={handleSave}
							disabled={loading}
							className="flex-1 py-3 rounded-lg font-bold bg-orange-600 hover:bg-orange-500 text-white shadow-lg transition-all transform active:scale-95 disabled:opacity-50"
						>
