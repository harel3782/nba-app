...
function App() {
    ...
    // --- התיקון כאן: בדיקה מול משתנה הסביבה בתוך הקומפוננטה ---
                ...
                <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="flex items-center gap-3 group hover:bg-white/5 p-1 rounded-full pr-3 transition-all border border-transparent hover:border-white/10"
                        >
                        ...
                        <div className="p-6 flex flex-col gap-10">
                            <section>
                                ...
                                <p className="text-gray-400 text-xs mb-4">
                                    Verifying data from your external script:
                                </p>
                            ...
                            <section>
                                <div className="mb-4 border-b border-gray-700 pb-2">
                                    <h2 className="text-xl font-bold text-white">
                                        2. Playoff Results Controls
                                    </h2>
                                </div>
                                <p className="text-gray-400 text-xs mb-4">
                                    Click to mark official winners:
                                </p>
                                <AdminResultsControl />
                            </section>
                        </div>
                ...
                {currentLeagueId && leagueDetails ? (
                        ...
                        <div className="w-full max-w-4xl flex justify-between items-end mb-4 px-2">
                            ...
                            {isLeagueAdmin && (
                                <button
                                    ...
                                    className="bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg text-sm text-gray-300 hover:text-white transition-all border border-white/10 flex items-center gap-2"
                                >
                                    ⚙️ League Settings
                                </button>
                            )}
                    ...
                    <div className="text-center py-20 text-white/50 animate-pulse">
                        <h3 className="text-2xl font-bold">
                            👈 Select or Create a League to Start
                        </h3>
                    </div>
                )}
            </main>
